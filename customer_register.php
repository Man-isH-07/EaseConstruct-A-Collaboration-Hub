...
$uploads_dir = 'C:\xampp\htdocs\EasyConstruct\Customer_Photo';
    ...
    if(($password == $c_password) && $exists==false){
        $sql = "INSERT INTO `registered_customer` ( `cus_name`, `cus_mobile`,`cus_dob`,`cus_mail`,`cus_pass`, `cus_c_pass`,`cus_photo`) VALUES ('$name', '$mobile_no', '$dob', '$mail', '$password','$c_password','$photo')";
...
<head>
    ...
    <title>EaseConstruct-Customer_Registration</title>
...
<!-- 
    ...
    echo ' <div class="alert alert-success alert-dismissible fade show" role="alert">
        ...
        <!-- <button type="button"  data-dismiss="alert" style=" padding: 5px;"><a style="text-decoration: none;color: black; font-weight: bolder;" href="customer_login.php">LOGIN</a></button> -->
                ...
                <div class="container my-4">
                    <form action="customer_register.php" method="post" enctype="multipart/form-data">
                        ...
                        <div class="reset_login">
                            ...
                            <button href="customer_login.php" class="reset-btn btn-primary">Reset</button>
                        </div>
                    </form>
                </div>
            </center>
